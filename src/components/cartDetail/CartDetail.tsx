      ...
      <section className={styles.cart}>
        <div className={styles.container}>
            ...
            <div className={styles.infoWrapper}>
              ...
              <div className={styles.description}>
                ...
                <p>
                  ...
                  ефективністю наступного покоління. Революційна нічна сироватка помітно зменшує
                  тонкі лінії й зморшки, зміцнює й вирівнює текстуру поверхні шкіри, оновлює й
                  покращує тон і тонус шкіри. Завдяки вмісту гіалуронової кислоти, гліцерину й
                  вітаміну Е, формула гідратує шкіру на всіх рівнях, ефективно підвищує тонус і
                  візуально омолоджує шкіру. Крім того, сироватка бореться з патогенними бактеріями,
                  які здатні викликати висипи, тому шкіра стає бездоганною і чистою.{' '}
                </p>
          ...
          <div className={styles.infoDetail}>
            ...
            <p>
              Максимізуйте результати нічного догляду за шкірою. Crystal Retinal стимулює вироблення
              колагену в шкірі, оновлює тонус і поверхню шкіри, зменшує тонкі лінії всього за 4
              тижні. Інноваційна формула забезпечує всі переваги ретинолу: антивікову дію,
              поліпшення сяйва, очищення, плюс таке ж незначне подразнення. Крем-сироватка легко
              поглинається й живить шкіру. Зміцнює, гідратує і омолоджує шкіру протягом ночі.
            </p>
            <h3>Інгредієнти</h3>
            <h3>Застосування</h3>
          </div>
